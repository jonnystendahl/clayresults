    ...
    <div class="row g-4 g-xl-5 align-items-start">
        ...
        <div class="col-xl-8">
            <div class="content-panel p-4 p-lg-5 mb-4">
                ...
                <form method="POST" action="{{ route('club-admin.clubs.events.store', $club) }}" class="row g-3">
                    @csrf
            ...
            <div class="vstack gap-3">
                @forelse ($events as $event)
                    <div class="content-panel p-4 p-lg-5">
                        <form method="POST" action="{{ route('club-admin.clubs.events.update', [$club, $event]) }}" class="row g-3">
                            @csrf
                            @method('PUT')
                        ...
                        <form method="POST" action="{{ route('club-admin.clubs.events.destroy', [$club, $event]) }}" class="mt-3">@csrf @method('DELETE')<button class="btn btn-outline-secondary" type="submit">Delete</button></form>
                    </div>
                @empty
