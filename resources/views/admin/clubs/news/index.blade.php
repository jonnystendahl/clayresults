    ...
    <div class="row g-4 g-xl-5 align-items-start">
        ...
        <div class="col-xl-8">
            <div class="content-panel p-4 p-lg-5 mb-4">
                ...
                <form method="POST" action="{{ route('club-admin.clubs.news.store', $club) }}" class="row g-3">
                    @csrf
                    <div class="col-12">
            ...
            <div class="vstack gap-3">
                @forelse ($newsPosts as $newsPost)
                    <div class="content-panel p-4 p-lg-5">
                        <form method="POST" action="{{ route('club-admin.clubs.news.update', [$club, $newsPost]) }}" class="row g-3">
                            @csrf
                            @method('PUT')
                        ...
                        <form method="POST" action="{{ route('club-admin.clubs.news.destroy', [$club, $newsPost]) }}" class="mt-3">
                            @csrf
                            @method('DELETE')
